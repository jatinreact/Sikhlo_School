                ...
                <div>
                    ...
                    <div className='Criteria_class'>
                        ...
                        <Grid className="Component_main_grid">
                            ...
                            <h4> Add Postal Dispatch</h4>
                                <Grid className="Component_main_grid">
                                    <Grid item md={12} >
                                        <div class="form-group pr-1">
                                            <label for="exampleInputEmail1">To Title *</label>
                                    ...
                                    <Card className="p-2 Card_shadow mt-2 card_height">
                                        ...
                                        <TableContainer component={Paper}>
                                            ...
                                            >
                                               ...
                                               <div className='mt-3'>
                                                   <span className='text-danger'>No data available in table</span>
                                               </div>
...
export default HOC(PostalDispatch)
